...
<div id="interfazGrafica" class="modal modal-lg fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <canvas align ="center" id="graficaFinal" style="" width="1200" height="800"></canvas>
            </div>
        </div>
    </div>
</div>
